...
bool loadMedia()
{
    ...
    keyPressSurfaces[KEY_PRESS_SURFACE_DEFAULT] = loadSurface("1.jpg");
    ...
    keyPressSurfaces[KEY_PRESS_SURFACE_UP] = loadSurface("2.jpg");
    ...
    keyPressSurfaces[KEY_PRESS_SURFACE_DOWN] = loadSurface("3.jpg");
    ...
    keyPressSurfaces[KEY_PRESS_SURFACE_LEFT] = loadSurface("4.jpg");
    ...
    keyPressSurfaces[KEY_PRESS_SURFACE_RIGHT] = loadSurface("5.jpg");
...
SDL_Surface* loadSurface(std::string path)
{
    ...
    else
    {
        ...
        {
            printf("Error converting surface ! SDL_Error: %s \n", path, SDL_GetError());
        }
    }
