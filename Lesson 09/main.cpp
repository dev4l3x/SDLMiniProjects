    ...
    if(init())
    {
        if(loadMedia())
        {
            ...
            while (!quit)
            {
                ...
                SDL_Rect bottomWideViewport;
                bottomWideViewport.x = 0;
                bottomWideViewport.y = SCREEN_HEIGHT / 2;
                bottomWideViewport.w = SCREEN_WIDTH;
                bottomWideViewport.h = SCREEN_HEIGHT / 2;
                SDL_RenderSetViewport(renderer, &bottomWideViewport);
